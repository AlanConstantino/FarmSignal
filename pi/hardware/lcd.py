...
class lcd:
   ...
   # prints strings to each respective LCD line
   def print_to_lcd(self, line1='', line2=''):
      self.clear()
      self.display_string(string=line1, line=1)
      self.display_string(string=line2, line=2)
